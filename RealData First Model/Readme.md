...
Возможно использование одного и того же LSTM-а, побольше, вместо микролстма, с одними и теми же весами, просто перезапуская его для генерации нового голоса, зная результаты старого сэмплирования.

## No aposter

Решение проблемы с "отсутствием" пауз: на вход при обучении следующему голосу подаётся любая выбранная предыдущим голосом нота, но с правильным ответом.
...
* в рамках общего LSTM-а для генерации голосов передавать в последующий состояния предыдущих.
